...
class SystemTestMain3(unittest.TestCase):
    ...
    # scenario system test n°3
    
    # Description : The user choose song 2 and run it
    # Precondition : The artwork is running with next song: n°1 and the next real song: n°2
    # Steps : 1) The user presses the key '2' on the keyboard. 2) The user presses the key '-' on the keyboard.
    # Output : The song 2 should be played, the next song should be song 5 and the next real song should be song 3
