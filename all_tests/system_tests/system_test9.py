...
class SystemTestMain9(unittest.TestCase):
    """system test : scenario 9."""

    # scenario system test n°9

    # Description : The user choose song 8 and run it
    # Precondition : The artwork is running with next song: n°1 and the next real song: n°2
    # Steps : 1) The user presses the key '8' on the keyboard. 2) The user presses the key '-' on the keyboard.
    # Output : The song 8 should be played, the next song should be song 5 and the next real song should be song 2
    ...
    def test_song_8(self):
        ...
        td.mod(td.op("/container31/project1/keyboardin1_callbacks")).onKey(None,'8','8',
                                                                           False, False,
                                                                           False, False,
                                                                           False, False,
                                                                           False, False,
