...
class SystemTestMain8(unittest.TestCase):
    ...
    # scenario system test n°8

    # Description : The user choose song 7 and run it
    # Precondition : The artwork is running with next song: n°1 and the next real song: n°2
    # Steps : 1) The user presses the key '7' on the keyboard. 2) The user presses the key '-' on the keyboard.
    # Output : The song 7 should be played, the next song should be song 5 and the next real song should be song 2

    def test_song_7(self):
        ...
        td.mod(td.op("/container31/project1/keyboardin1_callbacks")).onKey(None,'7','7',
                                                                           False, False,
                                                                           False, False,
                                                                           False, False,
                                                                           False, False,
