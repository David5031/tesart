...
class SystemTestMain4(unittest.TestCase):
    ...
    # scenario system test n°4

    # Description : The user choose song 3 and run it
    # Precondition : The artwork is running with next song: n°1 and the next real song: n°2
    # Steps : 1) The user presses the key '3' on the keyboard. 2) The user presses the key '-' on the keyboard.
    # Output : The song 3 should be played, the next song should be song 5 and the next real song should be song 4
    ...
    def test_song_3(self):
        ...
        td.mod(td.op("/container31/project1/keyboardin1_callbacks")).onKey(None,'3','3',
                                                                           False, False,
                                                                           False, False,
                                                                           False, False,
                                                                           False, False,
