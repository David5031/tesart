...
class SystemTestMain6(unittest.TestCase):
    """system test : scenario 6."""

    # tests for importation components
    ...
    # scenario system test n°6
    
    # Description : The user choose song 5 and run it
    # Precondition : The artwork is running with next song: n°1 and the next real song: n°2
    # Steps : 1) The user presses the key '5' on the keyboard. 2) The user presses the key '-' on the keyboard.
    # Output : The song 5 should be played, the next song should be song 2 and the next real song should be song 3
    
    def test_song_5(self): 
        ...
        td.mod(td.op("/container31/project1/keyboardin1_callbacks")).onKey(None,'5','5', False, False, False, False, False, False,False, False, False, True, 0, False, False, False) # press key 5
        td.mod(td.op("/container31/project1/keyboardin1_callbacks")).onKey(None,'-','-', False, False, False, False, False, False,False, False, False, True, 0, False, False, False) # press key -
