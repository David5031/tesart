...
class SystemTestMain18(unittest.TestCase):
    """system test : scenario 19."""
   
    # scenario system test n°19 
    
    # Description : test onCycle event with song number 5 and cycle number 1
    # Precondition : The artwork is running with the default timer values (song number to 1). Song number value  = 5 and cycle number value = 1
    # Steps :Simulate onCycle event
    # Output : The display number should be 0, the display timer should be 100 seconds
    ...
    def test_onCycle(self):
        ...
        self.numeroChanson.par.value0 = 5
        self.numeroCycle.par.value0 = 1
        ...
        self.assertEqual(self.numeroAffichage.par.value0, 0)
