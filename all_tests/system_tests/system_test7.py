...
class SystemTestMain7(unittest.TestCase):
    ...
    # scenario system test n°7

    # Description : The user choose song 6 and run it
    # Precondition : The artwork is running with next song: n°1 and the next real song: n°2
    # Steps : 1) The user presses the key '6' on the keyboard. 2) The user presses the key '-' on the keyboard.
    # Output : The song 6 should be played, the next song should be song 5 and the next real song should be song 2

    def test_song_6(self):
        ...
        td.mod(td.op("/container31/project1/keyboardin1_callbacks")).onKey(None,'6','6',
                                                                           False, False,
                                                                           False, False,
                                                                           False, False,
                                                                           False, False,
