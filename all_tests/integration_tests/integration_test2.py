...
class IntegrationTestMain2(unittest.TestCase):
    # scenario integration test n°2

    # Description : The user choose song 1
    # Precondition : The artwork is running.
    # Steps : 1) The user presses the key '1' on the keyboard. 
    # Output : The next song should be song 1 and next true song should be song 2
    ...
    def test_keyboard_1(self):
        ...
        self.assertEqual(vrai_prochain,2)
