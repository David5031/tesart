...
class IntegrationTestMain3(unittest.TestCase):
    # scenario integration test n°3
    
    # Description : The user choose song 2
    # Precondition : The artwork is running.
    # Steps : 1) The user presses the key '2' on the keyboard. 
    # Output : The next song should be song 2 and next true song should be song 3
