...
class IntegrationTestMain4(unittest.TestCase):
    # scenario integration test n°4
    # Description : The user choose song 3
    # Precondition : The artwork is running.
    # Steps : 1) The user presses the key '3' on the keyboard.
    # Output : The next song should be song 3 and next true song should be song 4
    ...
    def test_keyboard_3(self):
        ...
        self.assertEqual(vrai_prochain,4)
